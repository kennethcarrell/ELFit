...
def fitValues(APER,LWIN,HWIN,MEAN,DEPTH,STDDEV,CONTI,LOW,HIGH,WAVE,FLUX,SIGMA,skewkurt=False):
    ...
    try:
        center,eqw,halfmax,fwhm,lhm,rhm,emax,fwem,lem,rem,lskew,lskewErr,lkurt,lkurtErr = lineMeasure(CONTWAVE,CONTFLUX,CONTSIGMA,loLine,hiLine,fconti,bottom,False)
    except:
...
for i in range(1,len(eachline)):
    ...
    try:
        ...
        saveLine('auto2.txt',froot,"BAD",-9999.,-9999.,-9999.,-9999.,-9999.,-9999.,-9999.,-9999.,-9999.,-9999.,-9999.,-9999.,-9999.,-9999.,-9999.,-9999.,-9999.,-9999.,-9999.,-9999.,-9999.,-9999.,-9999.,-9999.,-9999.,-9999.,-9999.)
        continue
    ...
    saveLine('auto2.txt',froot,name,hjd,fmean,fmeanErr,fdepth,fdepthErr,fwidth,fwidthErr,fconti,fcontiErr,residual,sumeqw,integral,errorew,center,eqw,halfmax,fwhm,lhm,rhm,emax,fwem,lem,rem,lskew,lskewErr,lkurt,lkurtErr)
